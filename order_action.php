...
/*	$data['order_id']=$row['order_id'];	
	...
	$data['b_phone']=$row['b_phone'];	
	$data['email']=$row['email'];	
	$data['s_name']=$row['s_name'];	
	$data['s_area']=$row['s_area'];	
	$data['s_city']=$row['s_city'];
    $data['s_state']=$row['s_state'];	
    $data['s_pincode']=$row['s_pincode'];	
	$data['order_date']=$row['order_date'];	
	echo json_encode($data);
*/


    $output= '<div class="panel-body p20" id="invoice-item">                   
