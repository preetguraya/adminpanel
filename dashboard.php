...
require('db.php');
	...
	$items=0;
	$s="select * from order_items";
	$r=mysqli_query($con,$s);                 //****No. Of Products Sold******//
	while($ro=mysqli_fetch_assoc($r))
	{
		$items=$items+$ro['quantity'];
	}
	
    $profit=0;
	$x="select * from orders";
	$y=mysqli_query($con,$x);                 //****Total Profit******//
	while($z=mysqli_fetch_assoc($y))
	{
		$profit=$profit+$z['total'];
	} 
   
	$a="select * from register_user";
	$b=mysqli_query($con,$a);                 //****No. Of Customers******//
	$customers=mysqli_num_rows($b);
	
	$l="select * from subscribers";
	$m=mysqli_query($con,$l);                 //****No. Of Subscribers******//
	$subscribers=mysqli_num_rows($m);
?>
        <!--**********************************
            Content body start
        ***********************************-->
                ...
                <div class="row">
                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $items; ?></h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white">$<?php echo $profit; ?></h2>
                                    <p class="text-white mb-0"></p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Subscribers</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $subscribers; ?></h2>
                                    <p class="text-white mb-0"></p>
                                </div>
